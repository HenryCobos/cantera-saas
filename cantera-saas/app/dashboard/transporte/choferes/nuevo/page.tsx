...
export default function NuevoChoferPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error: insertError } = await supabase.from('choferes').insert({
      ...
      setError(err.message || 'Error al crear el chofer');
      setLoading(false);
    }
  };
      ...
      <div className="p-6">
        ...
        <div className="mx-auto max-w-2xl rounded-lg bg-white shadow">
          <div className="border-b border-gray-200 px-6 py-4">
            <h2 className="text-lg font-medium text-gray-900">Registrar Nuevo Chofer</h2>
            <p className="mt-1 text-sm text-gray-500">Agrega un nuevo chofer a la lista</p>
          </div>
