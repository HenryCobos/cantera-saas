...
export default function EditarGastoPage() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      setFormData({
        categoria: (gasto.categoria as 'combustible' | 'mantenimiento' | 'sueldos' | 'repuestos' | 'otro') || 'otro',
      ...
      <div className="p-6">
        ...
        <div className="mx-auto max-w-2xl rounded-lg bg-white shadow">
          <div className="border-b border-gray-200 px-6 py-4">
            <h2 className="text-lg font-medium text-gray-900">Editar Gasto</h2>
            <p className="mt-1 text-sm text-gray-500">Modifica la información del gasto</p>
          </div>
